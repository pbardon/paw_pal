...
(function() { this.JST || (this.JST = {}); this.JST["bookings/dog_booking_show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="dogBooking">\n\n    ');  if (sitter){ ; __p.push('\n\n\n    ');   } else { ; __p.push('\n       <div>\n         <table>\n           <th>\n             <td>Date Start:</td>\n             <td>Date End:</td>\n           </th>\n           <tr>\n             <td>',  booking.escape('date_start') ,' </td>\n             <td>Date End: ',  booking.escape('date_end') ,' </td>\n\n           </tr>\n         </table>\n       </div>\n    ');   } ; __p.push('\n\n\n    ');  if (sitter) { ; __p.push('\n\n      <div class="sitterBookingInformation">\n        <div>Sitter Name: ',  sitter.get('sitter_name') ,'</div>\n        <br>\n        <div>Price per Night: $',  sitter.get('price') ,'</div>\n        <div>\n          <img class="thumbnail" data-id="',  sitter.get('id') ,'" src="',  sitter.get('sitter_photo_small') ,'">\n        </div>\n      </div>\n\n\n\n    ');   } else { ; __p.push('\n\n    ');   }; __p.push('\n\n\n      <div>\n        <div>Date Start: ',  booking.escape('date_start') ,' <div>\n        <div>Date End: ',  booking.escape('date_end') ,' </div>\n      </div>\n\n      ');  if (booking.confirmed) { ; __p.push('\n        <h2 style="color:#3EFF1F">Confirmed</h2>\n      ');  }else { ; __p.push('\n        <h2 style="color:#FFE745">Pending</h2>\n      ');  }; __p.push('\n      ');  if (booking.completed) { ; __p.push('\n        <h2>Completed</h2>\n      ');  } ; __p.push('\n\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["bookings/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form id="newBookingForm" class="col-xs-12 col-md-4">\n\n  <h1> New Booking </h1>\n  <br>\n  <label for="dateStart">Date Start: </label>\n  <input type="text" class="form-control" name="date_start" id="dateStart" value="',  booking.escape('date_start') ,'">\n\n\n  <label for="dateEnd">Date End: </label>\n  <input type="text" class="form-control" name="date_end" id="dateEnd"  value="',  booking.escape('date_end') ,'">\n\n  <label for="bookingMessage" id="bookingMessageLabel">Message/Comments:</label>\n  <textarea class="form-control" name="message" id="bookingMessage" value="',  booking.escape('message') ,'"></textarea>\n\n  ');  if (!dogs) { ; __p.push('\n\n  ');  } else { ; __p.push('\n    <label for="dogSelect">Choose which dog you would like to book this stay for:</label>\n    <select name="dog_id" id="dogSelect">\n      ');  dogs.each(function(dog){ ; __p.push('\n          <option value="',  dog.escape('id') ,'">',  dog.escape('name') ,'</option>\n      ');   });  ; __p.push('\n    </select>\n\n  ');  } ; __p.push('\n\n  <input type="submit" class="btn btn-success" id="submitBooking" value="Request Booking!">\n</form>\n\n<script>\n $(function() {\n    $("#dateStart").datepicker();\n    $("#dateEnd").datepicker();\n  });\n</script>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["bookings/sitter_booking_show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="sitterBooking panel panel-info" data-id="',  booking.get('id') ,'">\n\n  ');  if (dog){ ; __p.push('\n    <h4 class="panel-heading">Booking: ',  dog.escape('name') ,'</h4>\n\n  ');  } ; __p.push('\n\n  <div class="row">\n\n    <div class="dogBookingInfo">\n\n      ');  if (dog){ ; __p.push('\n\n        <div class="col-xs-4">\n\n          <div class="bookingDogInfo">\n            <div>\n              <div>Dog Size: ',  dog.escape('size') ,'</div>\n              <div> Message: </div>\n              <div> ',  booking.escape('message') ,'</div>\n            </div>\n\n          </div>\n        </div>\n      ');  } ; __p.push('\n\n\n\n    ');  if (booking.get('completed')) { ; __p.push('\n\n      <div class="col-xs-4">\n\n        <h3> Comment on Booking </h3>\n      </div>\n\n    ');  }else { ; __p.push('\n\n      <div class="col-xs-4">\n\n        <div>\n          <div>Date Start: ',  booking.escape('date_start') ,' </div>\n          <div>Date End: ',  booking.escape('date_end') ,' </div>\n          <div class="panel panel-default">\n            <div class="panel-heading">\n              Message:\n            </div>\n            <div id="panel-body">\n              ',  booking.escape('message')  ,'\n            </div>\n          </div\n          </div>\n        </div>\n\n      ');  if (booking.get('confirmed')) { ; __p.push('\n        <h3> Booking Confirmed </h3>\n      ');  }else { ; __p.push('\n        <div class="bookingConfirmation">\n          <div class="confirmDiv" data-id="',  booking.get('id') ,'"><h2>Confirm? <button class="confirmBooking btn btn-success">✓</button></h2></div>\n          <div class="denyDiv" data-id="',  booking.get('id') ,'"><h2>Deny? <button class="denyBooking btn btn-danger">✖</button></h2></div>\n        </div>\n      ');  } ; __p.push('\n      </div>\n\n    ');   } ; __p.push('\n\n\n    ');  if (dog){ ; __p.push('\n      <div class="col-xs-4">\n\n        <img class="thumbnail" src="',  dog.get('dog_photo_small') ,'">\n        <div style="color: blue">Click to expand picture </div>\n\n      </div>\n    ');  } ; __p.push('\n\n  </div>\n\n\n  </div>\n\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["dogs/dog_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if (dog.get('name')) { ; __p.push('\n  <h2>Edit Dog Information</h2>\n\n');  } else { ; __p.push('\n\n  <h2> Add A New Dog!</h2>\n\n');  } ; __p.push('\n\n<form id="newDogForm" >\n\n  <label for="dogName">Name: </label>\n  <input type="text" class="form-control" name="name" id="dogName" value="',  dog.escape('name') ,'">\n\n\n  <label for="dogAge">Age: </label>\n  <input type="text" class="form-control" name="age" id="dogAge"  value="',  dog.escape('name') ,'">\n\n  <label for="dogDescription">Description:</label>\n  <textarea class="form-control" name="description" id="dogDescription" value="',  dog.escape('name') ,'"></textarea>\n  <br>\n  <br>\n  <label for="dogSize">Size:</label>\n  <select name="size" id="dogSize">\n\n    <option ',  (dog.escape('size') === 'small') ? 'selected' : '' ,' value=\'small\'>Small</option>\n    <option ',  (dog.escape('size') === 'medium') ? 'selected' : '' ,' value=\'medium\'>Medium</option>\n    <option ',  (dog.escape('size') === 'large') ? 'selected' : '' ,' value=\'large\'>Large</option>\n  </select>\n  <br>\n  <br>\n  ');  if (typeof (dog.get('dog_photo_small')) === 'undefined') { ; __p.push('\n\n  <label for="addPic">Add A Picture of Your Dog:</label>\n  <br>\n  <input type="file" name="dog_photo" id="addPic">\n\n  ');  }else { ; __p.push('\n\n    <label for="addPic">Change Dog Picture:</label>\n    <br>\n    <input type="file" name="dog_photo" id="addPic">\n\n\n  ');  } ; __p.push('\n\n  ');  if (dog.get('id')) { ; __p.push('\n    <button type=\'submit\' class=\'addSubmit btn btn-primary\'>Edit Dog</button>\n  ');  }else { ; __p.push('\n    <button type=\'submit\' class=\'addSubmit btn btn-success\'>Add Dog</button>\n  ');   } ; __p.push('\n\n\n  <br>\n  <br>\n\n\n\n\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["dogs/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1> Your Dogs: </h1>\n\n');  if (dogs.isEmpty()){  ; __p.push('\n  <h2> You haven\'t added any dogs yet :(</h2>\n');  } else { ; __p.push('\n\n  ');  dogs.each(function(dog){ ; __p.push('\n    <div class="dog col-xs-12 col-md-3">\n    <h2>',  dog.escape('name') ,'</h2>\n    <img class="img-responsive img-circle" src="',  dog.get('dog_photo_large') ,'">\n    <p>\n      <button class="btn btn-primary showDogProfile" data-id="',  dog.escape('id') ,'"> Show Dog Profile </button>\n    </p>\n    </div>\n\n  ');  }); ; __p.push('\n\n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["dogs/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="dogShowInfo">\n\n\n  <h1>',  dog.escape('name') ,' <button class="removeDog btn btn-danger">Remove Dog Profile</button></h1>\n\n  <div class="row">\n    <div class="dogShowPic col-xs-5">\n      <img class="img-responsive img-circle" src="',  dog.get('dog_photo_large') ,'">\n    </div>\n\n\n    <div class=\'dogShowContent col-xs-6\'>\n      <h5><strong>Description:</strong></h5>\n      <div id="dogDescription">\n        ',  dog.escape('description') ,'\n      </div\n\n      <div class="dogAttributes">\n        <div>Age:',  dog.escape('age') ,'</div>\n        <div>Size: ',  dog.escape('size') ,'</div>\n      <div>\n\n      <button class="btn btn-primary editDogInfo" data-id="',  dog.escape('id') ,'">Edit Dog Information</button>\n      </div>\n      </div>\n    </div>\n  </div>\n\n<div class="row">\n  <h3> Bookings: <h3>\n  <div class="dog_bookings">\n  </div>\n</div>\n</div>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["sitters/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n\n');  if (sitter.get('id')) { ; __p.push('\n<h2>Edit Sitter Information</h2>\n\n');  } else { ; __p.push('\n\n<h2> Enter Your Information To Become A Sitter!</h2>\n\n');  } ; __p.push('\n\n<form id="newSitterForm">\n  <div class="row">\n\n    <div class="leftSide col-xs-6">\n\n\n\n\n    <label for="sitterName">Sitter Profile Name: </label>\n    <input\n      type="text"\n      class="form-control"\n      name="sitter_name"\n      id="sitterName"\n      value="',  sitter.escape('sitter_name') ,'">\n\n    <label for="sitterDescription">Description:</label>\n    <textarea\n      class="form-control"\n      name="description"\n      id="sitterDescription"\n      >',  sitter.escape('description') ,'</textarea>\n\n    <label for="sitterPrice">Price Per Night: </label>\n    <div class="input-group">\n       <div class="input-group-addon">$</div>\n      <input\n          type="text"\n          class="form-control"\n          name="price"\n          id="sitterPrice"\n          value="',  sitter.escape('price') ,'">\n      </div>\n\n\n    <label>Able to Sit Dogs of Size:</label>\n    <div>\n      <div style="margin-left: 0px" class="form-checkbox">\n      <input type="checkbox" ',  (sitter.get('small') === true) ? 'checked' : '' ,'\n        class = "checkbox"\n        name = "small"\n        value="true">Small</div>\n        <div class="form-checkbox">\n        <input type = "checkbox" ',  (sitter.get('small') === true) ? 'checked' : '' ,'\n        class = "checkbox"\n        name="medium"\n        value="true">Medium</div>\n        <div class="form-checkbox">\n        <input type = "checkbox" ',  (sitter.get('small') === true) ? 'checked' : '' ,'\n        class = "checkbox"\n        name="large"\n        value="true">Large</div>\n      </div>\n    </div>\n    <div class="rightSide col-xs-6">\n      <label for="sitterAddress">Street Address:</label>\n      <input\n          type="text"\n          class="form-control"\n          name="street_address"\n          id="sitterAddress"\n          value="',  sitter.escape('street_address') ,'">\n\n      <label for="sitterCity">City:</label>\n      <input\n          type="text"\n          class="form-control"\n          name="city"\n          id="sitterCity"\n          value="',  sitter.escape('city') ,'">\n\n      <label for="sitterCity">State:</label>\n      <input\n          type="text"\n          class="form-control"\n          name="state"\n          id="sitterState"\n          value="',  sitter.escape('state') ,'">\n\n        <label for="sitterZip">Zipcode:</label>\n        <input\n            type="text"\n            class="form-control"\n            name="zipcode"\n            id="sitterZip"\n            value="',  sitter.escape('zipcode') ,'">\n\n\n\n    <br>\n    ');  if (!sitter.get('sitter_photo')) { ; __p.push('\n\n      <label for="addPic">Change Sitter Profile Picture:</label>\n      <br>\n      <input\n        type="file"\n        name="sitter_photo"\n        id="addSitterPic">\n\n\n    ');  }else { ; __p.push('\n\n      <label for="addSitterPic">Add A Sitter Profile Picture:</label>\n      <br>\n      <input\n        type="file"\n        name="sitter_photo"\n        id="addSitterPic">\n\n    ');  } ; __p.push('\n    <br>\n\n    ');  if (sitter.get('id')) { ; __p.push('\n      <input type=\'submit\' class=\'addSubmit btn btn-success\' value="Update Information">\n    ');  }else { ; __p.push('\n      <input type=\'submit\' class=\'addSubmit btn btn-success\' value="Create Sitter Profile!">\n    ');  } ; __p.push('\n  </form>\n</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["sitters/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<!-- <div class="sitters-feed"> -->\n\n\n  <!-- </div> -->\n\n  <form>\n    <label for="searchBar">Search For Dog Sitters:</label>\n    <div class="input-append searchBar">\n      <input type="text" id="searchParams" placeholder="Enter an address"/>\n\n      <button type="submit" id="search" class="btn btn-success">Search!</button>\n    </div>\n  </form>\n\n  <div class="row">\n\n  <div class="map-wrapper col-md-3 hidden-sm">\n\n    <div id="map-canvas" style="margin-top: 10%;width:450px;height:450px;">\n\n    </div>\n    <br>\n  </div>\n\n  <div id="sitterIndexWrapper col-xs-12">\n    <h2 style="margin-left: 40%;"> Sitter Listings: </h2>\n\n    <div class="sitterIndex col-xs-7 col-xs-offset-2"\n    </div>\n  </div>\n\n\n\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["sitters/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if (sitter.get('current_user_id') === sitter.get('user_id')) { ; __p.push('\n  ');  var logged_in = true; ; __p.push('\n');  }else { ; __p.push('\n  ');  var logged_in = false; ; __p.push('\n');  }; __p.push('\n<div class="sitterShowInfo row">\n\n  <div class="sitterInfo">\n    ');  if (logged_in) { ; __p.push('\n      <button class="removeSitterAccount btn btn-danger">Remove Sitter Listing</button>\n      ');  }else { ; __p.push('\n        <button class="bookNow btn btn-success">Book Now!</button>\n      ');  } ; __p.push('\n    <div class="sitterShowImage col-xs-3">\n      <img class="img-responsive" src="',  sitter.get('sitter_photo_large') ,'">\n    </div>\n\n    <div class="sitterShowContent col-xs-7">\n      <h2>',  sitter.escape('sitter_name') ,'</h2>\n\n      <ul>\n        <li>Price per Night: ',  sitter.escape('price') ,'</li>\n        <li>Description:\n          <p class="sitter-description">',  sitter.escape('description') ,'</p>\n        </li>\n        <li>Accepts Small Dogs? ',  (sitter.get('small')) ? "Yes" : "No" ,'</li>\n        <li>Accepts Medium Dogs? ',  (sitter.get('medium')) ? "Yes" : "No" ,'</li>\n        <li>Accepts Large Dogs? ',  (sitter.get('large')) ? "Yes" : "No" ,'</li>\n        ');  if (logged_in) { ; __p.push('\n            <button class="btn btn-primary editSitterInfo" data-id="',  sitter.escape('id') ,'">Edit Sitter Information </button>\n        ');   }  ; __p.push('\n        </li>\n      </ul>\n    </div>\n\n    <div class="lowerContent row">\n      ');  if(logged_in) { ; __p.push('\n        <div class="sitter_bookings col-xs-12">\n\n        </div>\n\n      ');  } ; __p.push('\n      <!-- <div class="sitterComments col xs-8">\n\n\n      </div> -->\n\n      <!-- <div class="mapWrapper col-xs-5 col-xs-offset-1">\n      </div> -->\n    </div>\n\n\n\n\n\n\n\n  </div>\n\n\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["sitters/sitter_index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n');  sitters.each(function(sitter){ ; __p.push('\n  <div class="row">\n    <!-- <div class="sitter-info"> -->\n    <div class="sitterItem">\n      <div class="row">\n        <div class = \'col-xs-8\'>\n          <img id="pawicon" src="https://s3-us-west-1.amazonaws.com/pet-sitter-development/pawicon.png"><h2>',  sitter.escape('sitter_name') ,'</h2>\n          <h5> Description: </h5>\n          <p>',  sitter.escape('description') ,'</p>\n        </div>\n        <div class="sitterIndexImg col-xs-2 col-xs-offset-1">\n          <img class="thumbnail" src="',  sitter.get('sitter_photo_small') ,'">\n          <br>\n          <div class="sitterInfoButton">\n            <button style="margin-top: 10px; margin-left:10%;" data-id="',  sitter.get('id') ,'" class="btn btn-success moreInfo">More Info</button>\n          </div>\n          <div class="index_price">\n            <h2> Cost/Night:\n            <div style="margin-left: 30%">$',  sitter.escape('price') ,'</div>\n            </h2>\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <!-- <div class="sitter-pic"> -->\n\n  </div>\n');  }); ; __p.push('\n');}return __p.join('');};
}).call(this);
/* =========================================================
